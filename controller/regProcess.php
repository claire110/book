...
if ($_SESSION['rights'] == 'Admin' ) {
  ...
  $_SESSION['message'] = "Registration failed, only admin can create user accounts";
  echo "Registration failed, only admin can create user accounts";
  echo "<br><a href='../view/pages/dashboard.php'>Go Back</a>";
}
?>